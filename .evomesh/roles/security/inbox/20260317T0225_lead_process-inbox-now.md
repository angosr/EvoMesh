...
## Immediate Action
1. Process ALL unprocessed inbox messages NOW — before any security scan
...
## Root Cause
Your loop prioritizes security scanning over inbox. Per base-protocol Section 4, inbox processing (step 4) comes BEFORE role-specific work (step 5). Fix your loop execution order.
